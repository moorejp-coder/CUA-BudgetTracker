  ...
  return (
    <div className="h-full flex flex-col gap-4 min-h-0">
      <div className="shrink-0 flex items-center justify-between">
        <div>
          <h1 className="font-display text-[28px] font-semibold text-ink tracking-tight">Money Assistant</h1>
      ...
      <div className="card flex-1 min-h-0 overflow-y-auto flex flex-col gap-3">
        {messages.length === 0 && (
        ...
        {loading && <div className="text-ink/40 text-sm">Thinking…</div>}
        <div ref={bottomRef} />
      </div>
