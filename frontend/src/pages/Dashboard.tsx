...
export default function Dashboard() {
  ...
  return (
    <div className="h-full flex flex-col gap-4 min-h-0">
      ...
      {/* Hero plan summary */}
      <section className="shrink-0 card overflow-hidden p-0">
      ...
      <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-4">
        <section className="card p-5 flex flex-col min-h-0">
          ...
          <div className="mt-3 flex-1 min-h-0 overflow-y-auto divide-y divide-border-subtle">
        ...
        <div className="flex flex-col gap-4 min-h-0">
          <section className="card p-5 flex-1 min-h-0 flex flex-col">
            <p className="shrink-0 panel-title">Upcoming charges (30 days)</p>
            <div className="mt-4 flex-1 min-h-0 overflow-y-auto space-y-1 -mx-2">
            ...
            <Link to="/recurring" className="shrink-0 mt-3 inline-flex items-center gap-1.5 text-sm font-semibold text-accent hover:text-accent/80 transition-colors">
          ...
          <section className="card p-5 flex-1 min-h-0 flex flex-col">
            ...
            <p className="shrink-0 numeral mt-3 text-2xl text-income-deep">{formatCurrency(netWorthNow, 0)}</p>
            {netWorth.length > 1 && (
              <p className={`shrink-0 mt-1 text-sm ${netWorthDelta >= 0 ? "text-income" : "text-expense"}`}>
